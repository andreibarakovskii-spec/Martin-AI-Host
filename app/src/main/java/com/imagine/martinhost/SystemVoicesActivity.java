...
public final class SystemVoicesActivity extends Activity implements TextToSpeech.OnInitListener {
 ...
 private void preview(Voice v){tts.stop();tts.setVoice(v);tts.setSpeechRate(1.08f);tts.speak(RussianTtsNormalizer.prepare("Привет, Андрей! Я Сергей. Сильное заявление. Сегодня говорю по-русски и с хорошим настроением."),TextToSpeech.QUEUE_FLUSH,null,"preview");}
