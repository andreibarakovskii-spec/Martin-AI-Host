...
public final class DiagnosticsActivity extends Activity {
 ...
 PartyScreen.text(this,root,"Тест: короткий вопрос; длинный вопрос с паузой; вопрос сразу после ответа; речь во время ответа (сейчас она не прерывает ведущего). Проверьте с той колонкой, которую будете использовать. Никакие настройки задержек в этой версии не изменены.",15);
