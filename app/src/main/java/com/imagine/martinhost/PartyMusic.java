...
public final class PartyMusic {
 ...
 private final List<Track> tracks=new ArrayList<>(); private int index;private boolean ducked,clipMode,backgroundMode;private float requestedVolume=1f;private Runnable clipDone;private Listener listener;private String status="Музыка не запущена";
 ...
 public void clip(String uri,Runnable done){requestedVolume=1f;open(uri,"Фрагмент для конкурса",6000,done,false);}
 ...
 private void finishClip(){Runnable d=clipDone;clipDone=null;clipMode=false;release();if(d!=null)d.run();}
 ...
 public void stop(){clipDone=null;clipMode=false;backgroundMode=false;release();emit("Музыка остановлена");}
}
